...
class TextGenerator:
    ...
    def generate_callsign(self) -> str:
        ...
        suffix = "".join(np.random.choice(list("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), size=suffix_length))
    ...
    def generate_content(self, content_type: str, target_length: int | None = None) -> str:
        """
...
def generate_random_text(length: int | None = None) -> str:
    ...
    content_types = ["random_chars", "random_words", "callsigns", "numbers", "abbreviations", "qso"]
